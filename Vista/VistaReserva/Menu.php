...
<body>
<section class="container-sm bg-white mt-mr1 p-4 row d-flex justify-content-center" id="contenedorOrden" >
        <div class="container-fluid d-flex justify-content-center align-items-center  mb-5" style="height: 100px;">
            <h1>Menu</h1>
        </div>
        <div class="row align-items-start mb-5" id="cartas">
            <div class="col card carta1 shadow-lg me-5"  style="height: 430px;" >
                ...
                <div class="card-body d-flex row justify-content-center align-items-center" style="height: 5%;">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop" style="width: 50%; height: 25%;">
                        $14000
                     </button>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Elija la hora su cantidad en porciones:
                    </div>
                    
                        <div class="col ms-5"> 
                            <label for="inputState ms-1" class="form-label">Hora:</label>
                            <select class="form-select mb-4" id="selector"  style="width: 150px;" aria-label="Default select example">
                        ...
                        <div class="col ms-5">
                            <label for="inputState ms-1" class="form-label">Numero Porciones:</label>
                            <input type="number" id="pizza-flavor-CarneT" name="pizza-flavor-CarneT" min="0" max="8">
                        </div>
                        <div class="col">
